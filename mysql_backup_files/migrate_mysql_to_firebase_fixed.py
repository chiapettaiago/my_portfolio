...
class MySQLToFirebaseMigrator:
    ...
    def migrate_users(self):
        ...
        try:
                ...
                for user in users:
                    try:
                        ...
                        user_data = {
                            ...
                            'mysql_id': user.get('id'),  # Preserva o ID original
            ...
            logger.error(f"❌ Erro na migração de usuários: {str(e)}")
    ...
    def migrate_posts(self):
        ...
        try:
            ...
            logger.error(f"❌ Erro na migração de posts: {str(e)}")
    ...
    def migrate_comments(self):
        ...
        try:
            with self.mysql_conn.cursor(pymysql.cursors.DictCursor) as cursor:
                # Verifica se a tabela comment existe
            ...
            logger.error(f"❌ Erro na migração de comentários: {str(e)}")
    ...
    def migrate_pageviews(self):
        ...
        try:
            ...
            logger.error(f"❌ Erro na migração de pageviews: {str(e)}")

    def migrate_powershell_scripts(self):
